...
@Composable
fun getMonth(externalMonth: Month? = null): String =
    when (
        externalMonth ?: Clock.System.now().toLocalDateTime(
...
//        this
//    ) {
//        1 -> stringResource(id = R.string.january_label)
//        2 -> stringResource(id = R.string.february_label)
//        3 -> stringResource(id = R.string.march_label)
//        Month.APRIL -> stringResource(id = R.string.april_label)
//        Month.MAY -> stringResource(id = R.string.may_label)
//        Month.JUNE -> stringResource(id = R.string.june_label)
//        Month.JULY -> stringResource(id = R.string.july_label)
